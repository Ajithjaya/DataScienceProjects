...
print(2 + 2)
print((50 - 5 * 6) / 4)  # follows BODMAS rule in implementing functions in case of only numerical variables are present
...
print(word[0])
print(word[4])
# If indices are given negative number, start counting from the right
